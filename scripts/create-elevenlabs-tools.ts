      ...
      api_schema: {
        ...
        request_body_schema: {
          ...
          properties: {
            ...
            staff_name: { type: 'string', description: "Staff member name, or 'anyone' if the customer has no preference. Always ask the customer before booking." },
          ...
          required: ['service_name', 'time', 'staff_name'],
        },
      },
    },
